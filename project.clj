(defproject posthere.io "1.0.4-SNAPSHOT"
  ...
  :dependencies [
    ...
    [com.taoensso/carmine "2.20.0-alpha5"] ; Redis client for Clojure https://github.com/ptaoussanis/carmine
  ...
  :profiles {
    ...
    :qa {
      ...
      :plugins [
        ...
        [jonase/eastwood "0.3.5"] ; Clojure linter https://github.com/jonase/eastwood
    ...
    :dev [:qa {
      ...
      :plugins [
        ...
        [lein-cljfmt "0.6.4"] ; Code formatting https://github.com/weavejester/cljfmt
      ]
      ;; REPL injections
      :injections [
