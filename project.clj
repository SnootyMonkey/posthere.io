(defproject posthere.io "1.0.1-SNAPSHOT"
  ...
  :dependencies [
    ...
    [com.taoensso/carmine "2.9.2"] ; Redis client for Clojure https://github.com/ptaoussanis/carmine
    ...
    ;; Client-side
    [org.clojure/clojurescript "0.0-3208"] ; ClojureScript compiler https://github.com/clojure/clojurescript
