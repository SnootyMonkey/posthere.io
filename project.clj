(defproject posthere.io "1.0.3-SNAPSHOT"
  ...
  :dependencies [
    ...
    [http-kit "2.3.0-alpha4"] ; Development Web server http://http-kit.org/
    [compojure "1.6.0"] ; Web routing https://github.com/weavejester/compojure
    [jumblerg/ring.middleware.cors "1.0.1"] ; CORS library https://github.com/jumblerg/ring.middleware.cors
    [raven-clj "1.5.1"] ; Clojure interface to Sentry error reporting https://github.com/sethtrain/raven-clj
    [enlive "1.1.6"] ; HTML Templating system for Clojure https://github.com/cgrand/enlive
    [com.taoensso/carmine "2.17.0"] ; Redis client for Clojure https://github.com/ptaoussanis/carmine
    [clj-time "0.14.2"] ; Clojure date/time library https://github.com/clj-time/clj-time
  ...
  :profiles {
    ...
    :qa {
      ...
      :plugins [
        ...
        [jonase/eastwood "0.2.6-beta2"] ; Clojure linter https://github.com/jonase/eastwood
